...
public abstract class GenericFileAggregatorServiceGenericServiceFixture : DbContextFixtureBase<TestGenericEntity>
{
    protected GenericFileAggregatorServiceGenericServiceFixture()
